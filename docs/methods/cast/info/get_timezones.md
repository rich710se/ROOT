...
## [Cast](https://ludeeus.github.io/ROOT/platforms#cast) - [Info](https://ludeeus.github.io/ROOT/classes/cast/info) - [`get_timezones`](https://ludeeus.github.io/ROOT/methods/cast/info/get_timezones)
...
async def sample():
    ...
    async with gdh_session() as session:
        ...
        test = await sample_class.get_timezones()
