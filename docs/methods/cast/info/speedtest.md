...
## [Cast](https://ludeeus.github.io/ROOT/platforms#cast) - [Info](https://ludeeus.github.io/ROOT/classes/cast/info) - [`speedtest`](https://ludeeus.github.io/ROOT/methods/cast/info/speedtest)
...
async def sample():
    ...
    async with gdh_session() as session:
        ...
        test = await sample_class.speedtest()
