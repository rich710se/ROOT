...
## [Cast](https://ludeeus.github.io/ROOT/platforms#cast) - [Info](https://ludeeus.github.io/ROOT/classes/cast/settings) - [`reboot`](https://ludeeus.github.io/ROOT/methods/cast/settings/reboot)

This can take a optional param, this can be `now` for a reboot, or `fdr` for Factory reset.
...
async def sample():
    ...
    async with gdh_session() as session:
        ...
        test = await sample_class.reboot()
