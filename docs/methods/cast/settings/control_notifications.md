...
## [Cast](https://ludeeus.github.io/ROOT/platforms#cast) - [Info](https://ludeeus.github.io/ROOT/classes/cast/settings) - [`control_notifications`](https://ludeeus.github.io/ROOT/methods/cast/settings/control_notifications)

This can take a required param, this can be `True` or `False`.
...
async def sample():
    ...
    async with gdh_session() as session:
        ...
        test = await sample_class.control_notifications(True)
