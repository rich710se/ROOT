...
## [Cast](https://ludeeus.github.io/ROOT/platforms#cast) - [Bluetooth](https://ludeeus.github.io/ROOT/classes/cast/bluetooth) - [`get_paired_devices`](https://ludeeus.github.io/ROOT/methods/cast/bluetooth/get_paired_devices)
...
async def sample():
    ...
    async with gdh_session() as session:
        ...
        test = await sample_class.get_paired_devices()
