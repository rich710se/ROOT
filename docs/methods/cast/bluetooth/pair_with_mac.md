...
## [Cast](https://ludeeus.github.io/ROOT/platforms#cast) - [Bluetooth](https://ludeeus.github.io/ROOT/classes/cast/bluetooth) - [`pair_with_mac`](https://ludeeus.github.io/ROOT/methods/cast/bluetooth/pair_with_mac)

You need to supply the mac address of the device you want to pair.
...
async def sample():
    ...
    async with gdh_session() as session:
        ...
        test = await sample_class.pair_with_mac("AA:BB:CC:DD:EE:FF")
