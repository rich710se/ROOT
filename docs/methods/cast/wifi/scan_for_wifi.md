...
## [Cast](https://ludeeus.github.io/ROOT/platforms#cast) - [Info](https://ludeeus.github.io/ROOT/classes/cast/wifi) - [`scan_for_wifi`](https://ludeeus.github.io/ROOT/methods/cast/wifi/scan_for_wifi)
...
async def sample():
    ...
    async with gdh_session() as session:
        ...
        test = await sample_class.scan_for_wifi()
