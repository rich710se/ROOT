...
## [Cast](https://ludeeus.github.io/ROOT/platforms#cast) - [Info](https://ludeeus.github.io/ROOT/classes/cast/wifi) - [`forget_network`](https://ludeeus.github.io/ROOT/methods/cast/wifi/forget_network)

This can take a required param, this is the `wpa_id` you can get by running [get_configured_networks](https://ludeeus.github.io/ROOT/methods/cast/wifi/get_configured_networks)
...
async def sample():
    ...
    async with gdh_session() as session:
        sample_class = await Cast(CAST_HOST, LOOP, session).wifi()
        test = await sample_class.forget_network(9)
