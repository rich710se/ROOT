...
## [Cast](https://ludeeus.github.io/ROOT/platforms#cast) - [Info](https://ludeeus.github.io/ROOT/classes/cast/wifi) - [`get_configured_networks`](https://ludeeus.github.io/ROOT/methods/cast/wifi/get_configured_networks)
...
async def sample():
    ...
    async with gdh_session() as session:
        ...
        test = await sample_class.get_configured_networks()
