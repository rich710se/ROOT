...
## [Cast](https://ludeeus.github.io/ROOT/platforms#cast) - [Assistant](https://ludeeus.github.io/ROOT/classes/cast/assistant) - [`notifications_enabled`](https://ludeeus.github.io/ROOT/methods/cast/assistant/notifications_enabled)

This takes one optional parameter.  

param | type | default | description
-- | -- | -- | --
start | bool | True | Enable notification
...
async def sample():
    ...
    async with gdh_session() as session:
        ...
        test = await sample_class.notifications_enabled()
